          ...
          <div style={{ display: 'flex', gap: '8rem', flexWrap: 'wrap' }}>
            ...
            <div style={{ minWidth: '200px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.4rem' }}>
                {settings.whatsapp && (
                  <a href={`https://wa.me/${settings.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', color: settings.footer_text_color ? settings.footer_text_color + 'aa' : '#888', textDecoration: 'none', fontSize: '1.05rem', transition: '0.3s' }} onMouseOver={(e) => e.currentTarget.style.color = settings.footer_text_color || '#fff'} onMouseOut={(e) => e.currentTarget.style.color = settings.footer_text_color ? settings.footer_text_color + 'aa' : '#888'}>
                ...
                {settings.instagram && (
                  <a href={settings.instagram.startsWith('http') ? settings.instagram : `https://instagram.com/${settings.instagram.replace('@', '')}`} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', color: settings.footer_text_color ? settings.footer_text_color + 'aa' : '#888', textDecoration: 'none', fontSize: '1.05rem', transition: '0.3s' }} onMouseOver={(e) => e.currentTarget.style.color = settings.footer_text_color || '#fff'} onMouseOut={(e) => e.currentTarget.style.color = settings.footer_text_color ? settings.footer_text_color + 'aa' : '#888'}>
                ...
                {settings.facebook && (
                  <a href={settings.facebook} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', color: settings.footer_text_color ? settings.footer_text_color + 'aa' : '#888', textDecoration: 'none', fontSize: '1.05rem', transition: '0.3s' }} onMouseOver={(e) => e.currentTarget.style.color = settings.footer_text_color || '#fff'} onMouseOut={(e) => e.currentTarget.style.color = settings.footer_text_color ? settings.footer_text_color + 'aa' : '#888'}>
