    ...
    return (
      <div className="glass-card" style={{ padding: '3.5rem 2.5rem', textAlign: 'center', maxWidth: '600px', margin: '4rem auto', borderRadius: '16px', border: '1px solid var(--border)' }}>
        ...
        <p style={{ color: 'var(--muted)', fontSize: '0.95rem', lineHeight: 1.5, marginBottom: '2rem' }}>
          As integrações avançadas de frete e envio (Correios, Melhor Envio, Frenet) não estão ativas no seu plano atual (<strong>Básico - Apenas Catálogo WhatsApp</strong>). Faça um upgrade agora mesmo para automatizar cálculos de frete e gerar etiquetas de envio integradas!
        </p>
